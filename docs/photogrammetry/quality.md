...
An inherent problem of photogrammetry 3d scanning is, that the models will not come with an accurate scale. Therefore, it is always* necessary to scale the model using a reference measurement.
